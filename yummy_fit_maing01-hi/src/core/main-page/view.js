...
const View = createVisualComponent({
  ...
  render() {
    ...
    return (
      <>
        <div className={Css.main()}> <ModalOnButton header="Choose date" colorScheme="primary" size="l"
                children={ <DisplayDate />}/> 
        </div>
        <div className={Css.main()}>
        <ModalOnButton header="Add meal" children={"Add meal form"} size="xl"
                footer={
                  <Uu5Elements.Grid
        ...
        <ModalOnButton header="Add activity" children={"Add activity form"} size="xl"
                footer={
                  <Uu5Elements.Grid
                    templateColumns={{ xs: "repeat(2, 1fr)", s: "repeat(2, auto)" }}
                    columnGap={Uu5Elements.UuGds.SpacingPalette.getValue(["fixed", "c"])}
        ...
        <ModalOnButton header="Add water" children={"Add water form"} size="xl"
                footer={
                  <Uu5Elements.Grid
                    templateColumns={{ xs: "repeat(2, 1fr)", s: "repeat(2, auto)" }}
                    columnGap={Uu5Elements.UuGds.SpacingPalette.getValue(["fixed", "c"])}
